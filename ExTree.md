...
- ### [Question 1 - Basic Arithmetic Eval](#question-1---basic-arithmetic-eval)
...
- ### [Question 9 - Safe Boolean and Integer Eval Using Maybe](#question-9---safe-boolean-and-integer-eval-using-maybe)
- [Question 10 - If Expression](#question-10---if-expression)
- ### [Question 11 - Variables with Environment](#question-11---variables-with-environment)
...
- ### 2[Question 17 - Constant Folding](#question-17---constant-folding)
- ### 2[Question 18 - Algebraic Simplification](#question-18---algebraic-simplification)
- ### 2[Question 19 - Fold for Expression Trees](#question-19---fold-for-expression-trees)
- ### 2[Question 20 - Rebuild Eval Using Fold](#question-20---rebuild-eval-using-fold)
...
- ### [Question 23 - Convert Logical Expr to Nand Circuit](#question-23---convert-logical-expr-to-nand-circuit)
- ### [Question 24 - Evaluate Nand Circuit](#question-24---evaluate-nand-circuit)
